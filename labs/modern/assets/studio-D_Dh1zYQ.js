...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ac(e,t,n){let r=new Float32Array(Gs),i=new W(0,1,0);return new vo({name:`SphericalGaussianBlur`,defines:{n:Gs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:cc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function oc(){return new vo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:cc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function sc(){return new vo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:cc(),fragmentShader:`
	...
	`}var lc=class extends $t{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Pi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Pl={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Fl(e,t){let n=Pl[t];return n===void 0?(B(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Il=new W;function Ll(){return K.getLuminanceCoefficients(Il),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Il.x.toFixed(4)}, ${Il.y.toFixed(4)}, ${Il.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},_d=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},vd=new ts(-1,1,1,-1,0,1),yd=new class extends Mr{constructor(){super(),this.setAttribute(`position`,new Y([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new Y([0,2,0,0,2,0],2))}},bd=class{constructor(e){this._mesh=new X(yd,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,vd)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},xd=class extends _d{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof vo?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=ho.clone(e.uniforms),this.material=new vo({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new bd(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Sd=class extends _d{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Cd=class extends _d{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},wd=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new U);this._width=n.width,this._height=n.height,t=new $t(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:C}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new xd(gd),this.copyPass.material.blending=0,this.timer=new cs}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Sd!==void 0&&(r instanceof Sd?n=!0:r instanceof Cd&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new U);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Td=class extends _d{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new J}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Ed={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new J(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Dd.BlurDirectionX=new U(1,0),Dd.BlurDirectionY=new U(0,1);var Od={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},kd=class extends _d{constructor(){super(),this.isOutputPass=!0,this.uniforms=ho.clone(Od.uniforms),this.material=new yo({name:Od.name,uniforms:this.uniforms,vertexShader:Od.vertexShader,fragmentShader:Od.fragmentShader}),this._fsQuad=new bd(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},K.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Ad=new W;function jd(e,t,n,r,i,a){let o=2*Math.PI*i/4,s=Math.max(a-2*i,0),c=Math.PI/4;Ad.copy(t),Ad[r]=0,Ad.normalize();let l=.5*o/(o+s),u=1-Ad.angleTo(e)/c;return Math.sign(Ad[n])===1?u*l:s/(o+s)+l+l*(1-u)}var Md=class e extends zi{constructor(e=1,t=1,n=1,r=2,i=.1){let a=r*2+1;if(i=Math.min(e/2,t/2,n/2,i),super(1,1,1,a,a,a),this.type=`RoundedBoxGeometry`,this.parameters={width:e,height:t,depth:n,segments:r,radius:i},a===1)return;let o=this.toNonIndexed();this.index=null,this.attributes.position=o.attributes.position,this.attributes.normal=o.attributes.normal,this.attributes.uv=o.attributes.uv;let s=new W,c=new W,l=new W(e,t,n).divideScalar(2).subScalar(i),u=this.attributes.position.array,d=this.attributes.normal.array,f=this.attributes.uv.array,p=u.length/6,m=new W,h=.5/a;for(let r=0,a=0;r<u.length;r+=3,a+=2)switch(s.fromArray(u,r),c.copy(s),c.x-=Math.sign(c.x)*h,c.y-=Math.sign(c.y)*h,c.z-=Math.sign(c.z)*h,c.normalize(),u[r+0]=l.x*Math.sign(s.x)+c.x*i,u[r+1]=l.y*Math.sign(s.y)+c.y*i,u[r+2]=l.z*Math.sign(s.z)+c.z*i,d[r+0]=c.x,d[r+1]=c.y,d[r+2]=c.z,Math.floor(r/p)){case 0:m.set(1,0,0),f[a+0]=jd(m,c,`z`,`y`,i,n),f[a+1]=1-jd(m,c,`y`,`z`,i,t);break;case 1:m.set(-1,0,0),f[a+0]=1-jd(m,c,`z`,`y`,i,n),f[a+1]=1-jd(m,c,`y`,`z`,i,t);break;case 2:m.set(0,1,0),f[a+0]=1-jd(m,c,`x`,`z`,i,e),f[a+1]=jd(m,c,`z`,`x`,i,n);break;case 3:m.set(0,-1,0),f[a+0]=1-jd(m,c,`x`,`z`,i,e),f[a+1]=1-jd(m,c,`z`,`x`,i,n);break;case 4:m.set(0,0,1),f[a+0]=1-jd(m,c,`x`,`y`,i,e),f[a+1]=1-jd(m,c,`y`,`x`,i,t);break;case 5:m.set(0,0,-1),f[a+0]=jd(m,c,`x`,`y`,i,e),f[a+1]=1-jd(m,c,`y`,`x`,i,t)}}static fromJSON(t){return new e(t.width,t.height,t.depth,t.segments,t.radius)}},Nd=new bo({color:2435884,metalness:.55,roughness:.36}),Pd=new bo({color:12239552,metalness:.8,roughness:.27}),Fd=new bo({color:11769696,metalness:.78,roughness:.28}),Id=new Set([Nd,Pd,Fd]);function Ld(e,t,n,r){let i=new X(new Md(...t,2,Math.min(...t)*.14),r);return i.position.fromArray(n),i.castShadow=!0,i.receiveShadow=!0,e.add(i),i}function Rd(e,t,n,r,i=Pd,a=20){let o=new W(...t),s=new W(...n),c=s.clone().sub(o),l=new X(new Vi(r,r,c.length(),a),i);return l.position.copy(o.add(s).multiplyScalar(.5)),l.quaternion.setFromUnitVectors(new W(0,1,0),c.normalize()),l.castShadow=!0,e.add(l),l}function zd(e,t=`#dceaf5`,n=`transparent`,r=512,i=128){let a=document.createElement(`canvas`);a.width=r,a.height=i;let o=a.getContext(`2d`);o.clearRect(0,0,r,i),n!==`transparent`&&(o.fillStyle=n,o.fillRect(0,0,r,i)),o.fillStyle=t,o.textAlign=`center`,o.textBaseline=`middle`,o.font=`500 ${i*.48}px ui-monospace, monospace`,o.fillText(e,r/2,i/2,r*.94);let s=new Fi(a);return s.colorSpace=Ue,s}function Bd(e,t,n,r,i,a=`#283540`,o=`#e5ebef`){let s=new X(new ro(r,i),new Ur({map:zd(t,a,o),side:2}));return s.position.fromArray(n),s.rotation.x=Math.PI/2,e.add(s),s}function Vd(e,t,n,r,i){let a=new An;a.position.fromArray(t),a.userData={action:n,key:r,axis:i},Rd(a,[0,.004,0],[0,-.012,0],.012,Nd,32);for(let e=0;e<20;e++){let t=e*Math.PI/10;Rd(a,[.012*Math.cos(t),.001,.012*Math.sin(t)],[.012*Math.cos(t),-.01,.012*Math.sin(t)],65e-5,Pd,6)}return Ld(a,[.0018,.002,.007],[0,-.013,.004],Fd),a.traverse(e=>Object.assign(e.userData,{action:n,key:r,axis:i})),e.add(a),a}function Hd(e,t,n,r){for(let i of[-1,1])for(let a of[-1,1])Rd(e,[i*t*.38,a*n*.34,r],[i*t*.38,a*n*.34,r+.012],.01,Nd)}function Ud(e,t){return Rd(e,[t[0],t[1],t[2]-.002],[t[0],t[1],t[2]+.002],.003,Pd,6)}function Wd(e,t,n=.13,r=.085,i){let a=-t.position[2];Ld(e,[n,r,.018],[0,0,a+.021],Nd),Hd(e,n,r,a);for(let t of[-n*.35,n*.35])Ud(e,[t,0,a+.032]);Rd(e,[0,0,a+.032],i??[0,0,-.18],.009,Pd),Rd(e,[0,0,a+.035],[0,0,a+.08],.017,Nd),Vd(e,[0,-.025,a+.055],`lock`,`locked`)}function Gd(e,t,n){let r=e.getObjectByName(`supply-knob`);r&&(r.rotation.y=(t.params.value/(t.kind===`current`?3:300)-.5)*Math.PI*1.5);let i=e.getObjectByName(`supply-display`);if(!i)return;let a=n?.supplies[t.id],o=`${(t.enabled?t.kind===`voltage`?a?.voltage??0:a?.current??0:0).toFixed(t.kind===`voltage`?1:2)} ${t.kind===`voltage`?`V`:`A`}`;if(i.userData.text===o)return;let s=i.material.map,c=s.image,l=c.getContext(`2d`);l.fillStyle=`#14222f`,l.fillRect(0,0,c.width,c.height),l.fillStyle=t.enabled?`#d9efff`:`#577184`,l.textAlign=`center`,l.textBaseline=`middle`,l.font=`500 ${c.height*.48}px ui-monospace, monospace`,l.fillText(o,c.width/2,c.height/2,c.width*.94),s.needsUpdate=!0,i.userData.text=o}function Kd(a,o,s=!1){let c=new An;c.position.fromArray(a.position);let l=new An;if(l.quaternion.fromArray(a.quaternion),c.add(l),e(a)){c.quaternion.fromArray(a.quaternion),l.quaternion.identity();let e=new bo({color:14476007,roughness:.43,metalness:.3});Ld(l,[.235,.17,.13],[0,0,0],e),Hd(l,.235,.17,-.077),Ld(l,[.218,.002,.115],[0,-.086,0],e),Bd(l,a.kind===`voltage`?`DC VOLTAGE SUPPLY`:`DC CURRENT SUPPLY`,[0,-.087,.044],.19,.014);let t=o?.supplies[a.id],n=Bd(l,`${(a.enabled?a.kind===`voltage`?t?.voltage??0:t?.current??0:0).toFixed(a.kind===`voltage`?1:2)} ${a.kind===`voltage`?`V`:`A`}`,[0,-.088,.016],.148,.029,a.enabled?`#d9efff`:`#577184`,`#14222f`);n.name=`supply-display`;let r=Vd(l,[-.071,-.09,-.028],`parameter`,`value`);r.name=`supply-knob`,r.rotation.y=(a.params.value/(a.kind===`current`?3:300)-.5)*Math.PI*1.5,Bd(l,`OUTPUT`,[.067,-.087,-.048],.044,.01);let i=Ld(l,[.014,.005,.018],[.088,-.089,-.02],new bo({color:a.enabled?2515529:3226678,emissive:a.enabled?1192738:0}));i.userData.action=`power`;for(let e of[-.102,.102])for(let t of[-.049,.049]){let n=Rd(l,[e,-.087,t],[e,-.09,t],.0025,Fd,6);n.userData.action=`grab`}for(let e=0;e<10;e++)Ld(l,[.001,.058,.002],[-.075+e*.016,.027,.065],Nd)}else if(a.kind===`tube`){Wd(c,a,.12,.1,[0,0,-.12]),Rd(c,[0,0,-.16],[0,0,-.115],.033,Nd);let e=new xo({color:12838625,metalness:.03,roughness:.08,transparent:!0,opacity:s?.04:.12,transmission:.18,ior:1.47,thickness:.003,side:0,depthWrite:!1,envMapIntensity:.55}),t=new X(new oo(a.params.radius,64,40),e);t.name=`glass`,t.renderOrder=5,l.add(t);let n=new X(new Vi(.023,.021,.072,32),e.clone());n.rotation.x=Math.PI/2,n.position.z=-.155,l.add(n);let r=i({...a,position:[0,0,0],quaternion:[0,0,0,1]}),u=r.position,d=r.direction,f=e=>u.map((t,n)=>t+d[n]*e);Rd(l,f(-.044),f(-.016),.016,Nd,32),Rd(l,f(-.018),f(-.007),.01,Pd,32);let p=new X(new so(.007,.0012,8,24),Fd);p.position.fromArray(f(-.005)),p.quaternion.setFromUnitVectors(new W(0,0,1),new W(...d)),l.add(p),Rd(l,[-.075,0,-.105],f(-.027),.0025,Pd);let m=Rd(l,f(-.032),f(-.018),.003,new Ur({color:(o?.loads[a.id]?.voltage??0)>0?16756055:6045744}));m.userData.action=`grab`;for(let e of[-1,1])Rd(l,[e*.014,0,-.165],[e*.014,0,-.1],.0015,Fd);Vd(c,[.06,-.022,-a.position[2]+.055],`parameter`,`tilt`)}else if(a.kind===`coil`){let e=a.params.radius;Wd(c,a,.2,.076,n([0,0,-e-.01],a.quaternion));let t=Ld(l,[.05,.024,.016],[0,0,-e-.016],Nd);t.name=`saddle`;let r=new bo({color:11036734,metalness:.85,roughness:.3});for(let t=0;t<13;t++){let n=new X(new so(e,.0023,8,112),r);n.rotation.x=Math.PI/2,n.position.y=(t-6)*.0043,n.castShadow=!0,l.add(n)}for(let t of[-.032,.032]){let n=new X(new so(e,.007,10,96),Nd);n.rotation.x=Math.PI/2,n.position.y=t,l.add(n)}for(let t of[Math.PI/2,Math.PI*1.5])Ld(l,[.034,.077,.018],[Math.cos(t)*e,0,Math.sin(t)*e],Nd),Ud(l,[Math.cos(t)*e,0,Math.sin(t)*e+.012]);Vd(c,[0,-.04,-a.position[2]+.058],`rotate`,`yaw`,[0,0,1])}else if(a.kind===`plates`){let e=new bo({color:10988192,roughness:.29,metalness:.8});for(let t of[-1,1]){Ld(l,[a.params.length,a.params.width,.002],[0,0,t*a.params.gap/2],e);for(let e of[-1,1])Rd(l,[e*a.params.length*.4,a.params.width*.5,-a.params.gap/2-.007],[e*a.params.length*.4,a.params.width*.5,a.params.gap/2+.007],.0025,Fd)}Rd(l,[0,.026,-.015],[0,.026,-.06],.003,Pd)}else if(a.kind===`screen`){let e=new X(new Bi(a.params.radius,64),new bo({color:11058585,roughness:.72,side:2}));e.rotation.y=Math.PI/2,l.add(e);let t=new X(new so(a.params.radius,.003,8,64),Nd);t.rotation.y=Math.PI/2,l.add(t),Rd(l,[0,0,-a.params.radius],[0,0,-a.params.radius-.035],.003,Pd)}else Ld(l,[.003,a.params.width,a.params.height],[0,0,0],Nd),Rd(l,[0,0,-a.params.height/2],[0,0,-a.params.height/2-.028],.003,Pd);for(let n of r(a)){let r=new An;r.position.fromArray(t(a,n.id)).sub(new W(...a.position)),e(a)&&r.position.fromArray(n.p),qd(a)&&r.position.fromArray(n.p).applyQuaternion(new Pt(...a.quaternion)),Rd(r,[0,.002,0],[0,-.006,0],.0065,new bo({color:n.positive?12930870:1712162,metalness:.25,roughness:.45})),Rd(r,[0,-.006,0],[0,-.008,0],.0025,Fd);let i=new X(new oo(.01,12,8),new Ur({transparent:!0,opacity:0,depthWrite:!1}));r.add(i),r.traverse(e=>{e.userData.action=`port`,e.userData.port=n.id}),c.add(r)}return c.traverse(e=>e.userData.device=a.id),c}var qd=e=>e.kind===`plates`;function Jd(e,n){let r=n.devices.find(t=>t.id===e.a.device),i=n.devices.find(t=>t.id===e.b.device);if(!r||!i)return null;let a=new W(...t(r,e.a.port)),o=new W(...t(i,e.b.port)),s=(e,t)=>{let r=e.parentId?n.devices.find(t=>t.id===e.parentId&&t.kind===`tube`):void 0;if(e.kind!==`plates`||!r)return[t,t.clone().add(new W(0,-.025,0))];let i=t.z>e.position[2]?-.009:.009;return[t,t.clone().add(new W(0,-.012,-.015)),new W(r.position[0]+i,r.position[1],r.position[2]-.14),new W(r.position[0]+i,r.position[1],.025),new W(r.position[0]+i,r.position[1]-.055,.015)]},c=s(r,a),l=s(i,o),u=c.at(-1),d=l.at(-1),f=u.clone().add(d).multiplyScalar(.5);f.y-=.075,f.z=.006;let p=new X(new co(new Qi([...c,f,...l.reverse()],!1,`centripetal`),48,.0027,8,!1),new bo({color:e.color,roughness:.6}));return p.castShadow=!0,p.userData.wire=e.id,p}function Yd(e){e.traverse(e=>{let t=e;if(t.geometry?.dispose(),t.material)for(let e of Array.isArray(t.material)?t.material:[t.material]){if(Id.has(e))continue;let t=e;t.map?.dispose(),t.dispose()}})}var Xd=class extends zn{constructor(){super(),this.name=`RoomEnvironment`,this.position.y=-3.5;let e=new zi;e.deleteAttribute(`uv`);let t=new bo({side:1}),n=new bo,r=new es(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);let i=new X(e,t);i.position.set(-.757,13.219,.717),i.scale.set(31.713,28.305,28.591),this.add(i);let a=new fi(e,n,6),o=new kn;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);let s=new X(e,Zd(50));s.position.set(-16.116,14.37,8.208),s.scale.set(.1,2.428,2.739),this.add(s);let c=new X(e,Zd(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);let l=new X(e,Zd(17));l.position.set(14.904,12.198,-1.832),l.scale.set(.15,4.265,6.331),this.add(l);let u=new X(e,Zd(43));u.position.set(-.462,8.89,14.52),u.scale.set(4.38,5.441,.088),this.add(u);let d=new X(e,Zd(20));d.position.set(3.235,11.486,-12.541),d.scale.set(2.5,2,.1),this.add(d);let f=new X(e,Zd(100));f.position.set(0,20,0),f.scale.set(1,.1,1),this.add(f)}dispose(){let e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(let t of e)t.dispose()}};function Zd(e){return new So({color:0,emissive:16777215,emissiveIntensity:e})}function Qd(e,t){e.background=new J(2436664),e.fog=new Rn(2436664,4,10);let n=new Xd,r=new ec(t),i=r.fromScene(n,.03);e.environment=i.texture,e.environmentIntensity=.65,n.dispose(),r.dispose(),e.add(new Bo(14477549,4081745,1.1));let a=new rs(15988474,3.4);a.position.set(-1,-1.3,2),a.castShadow=!0,a.shadow.mapSize.set(2048,2048),Object.assign(a.shadow.camera,{left:-1.5,right:1.5,top:1.3,bottom:-1.3,near:.2,far:5}),a.shadow.normalBias=.001,a.shadow.bias=-2e-4,e.add(a);let o=new rs(14084090,1.7);o.position.set(.9,.5,1.5),e.add(o);let s=new An;e.add(s);let c=new bo({color:3291973,metalness:.35,roughness:.48});Ld(s,[1.55,.93,.06],[0,0,-.031],c),Ld(s,[1.56,.94,.009],[0,0,-.059],Nd);for(let e of[-.6,.6])for(let t of[-.33,.33])Ld(s,[.052,.052,.6],[e,t,-.36],Pd);let l=new X(new ro(20,20),new bo({color:6384501,roughness:.9}));l.position.z=-.68,l.receiveShadow=!0,s.add(l),Ld(s,[4,.08,2.5],[0,1.05,.6],new bo({color:9082270,roughness:.98})),Ld(s,[1.35,.05,.68],[-.3,.987,.6],new bo({color:2107956,roughness:1}));for(let e of[.245,.955])Ld(s,[1.4,.075,.028],[-.3,.972,e],Pd);for(let e of[-1,.4])Ld(s,[.025,.075,.7],[e,.972,.6],Pd);let u=new X(new ro(.75,.2),new Ur({map:zd(`F = q (E + v × B)`,`#bacbd7`,`#202a34`),toneMapped:!1}));u.rotation.x=Math.PI/2,u.position.set(-.3,.956,.69),s.add(u),Ld(s,[.62,.016,.88],[.86,.98,.62],new Ur({color:14543604}));for(let e of[.53,.86,1.19])Ld(s,[.02,.06,.93],[e,.94,.62],Pd);for(let e of[.16,.62,1.08])Ld(s,[.69,.06,.02],[.86,.94,e],Pd);Ld(s,[3,.3,.04],[0,.74,.12],c);for(let e=0;e<7;e++)Ld(s,[.085,.11,.055],[-.95+e*.17,.8,.169],new bo({color:e%2?8358805:12107974,roughness:.7}));return{env:i,key:a}}export{ho as $,fi as A,gi as B,Qi as C,Ye as D,Vi as E,bo as F,zn as G,Pt as H,u as I,io as J,vo as K,kn as L,X as M,Ur as N,An as O,xo as P,co as Q,va as R,Mr as S,Hi as T,Cs as U,ro as V,Ue as W,Xt as X,oo as Y,so as Z,_d as _,Yd as a,Os as b,Pd as c,Gd as d,U as et,kd as f,bd as g,wd as h,Fd as i,p as j,C as k,Rd as l,Td as m,Nd as n,$t as nt,Kd as o,Dd as p,ya as q,Ld as r,Jd as s,Qd as t,W as tt,zd as u,rd as v,J as w,vr as x,qu as y,Qo as z};